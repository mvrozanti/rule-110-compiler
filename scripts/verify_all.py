...
PHASES = [
    ...
    ("Phase 7: BF -> Cook CTS tape -> R110 IC -> evolve -> decode round-trip",
     ["pytest", "tests/test_bf_end_to_end_cook.py", "-q"]),
    ("Phase 7: SLOW headline demo — BF '++' yields 8 cook crossings inside R110",
     ["pytest", "tests/test_bf_end_to_end_cook.py", "-q", "-m", "slow"]),
