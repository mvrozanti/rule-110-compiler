...
158 tests pass + 1 slow demo (deselected by default), 1 xfailed. Each row of the table flips to `verified` only
...
| 7 | **BF '++' yields 8 verified Cook crossings inside R110** (slow, ~40 min) | **verified** |
